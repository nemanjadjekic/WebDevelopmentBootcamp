...
app.get("/posts/:postName", function (req, res) {
  ...
  posts.forEach(function (post) {
    const storedTitleLowCase = lodash.lowerCase(post.title);
    const storedTitleKebabCase = lodash.kebabCase(storedTitleLowCase);
    const storedTitle = storedTitleKebabCase;
